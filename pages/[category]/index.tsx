...
export const getStaticPaths: GetStaticPaths = async (ctx) => {
  const { organicAll } = await graphQLClientP.request(CATEGORY, { site: `${process.env.API_SITE}`})
...
//   const { organicAll } = await graphQLClientP.request(CATEGORY, { site: `${process.env.API_SITE}`})
// 	// console.log(JSON.stringify(organicAll, undefined, 2 ));
// 	// console.log(organicAll)
