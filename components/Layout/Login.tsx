...
export const Login = () => {
	...
	return (
		...
		<div
			...
			className="h-screen flex bg-gray-100 from-lime-400 to-lime-900 w-full "
		>
					...
					<form onSubmit={handleSubmit(onLoginSubmit)}>
						...
						<div className="mt-8">
							<button
								...
								className="focus:ring-2 focus:ring-offset-2 focus:ring-lime-00 text-sm font-semibold leading-none text-white focus:outline-none bg-lime-500 border rounded hover:bg-lime-600 py-4 w-full"
							>
								Login
							</button>
						</div>
