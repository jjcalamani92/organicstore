...
export const FormHardware: FC<Props> = ({ product }) => {
  ...
  const onSubmit = async (form: FormData) => {
    ...
    if (form._id) {
      await axios.put(`${process.env.APIP_URL}/api/organic/${product._id}`, data)
      router.replace('/admin')

    } else {
      await axios.post(
        `${process.env.APIP_URL}/api/organic`, data);
      router.replace(`/admin`)
    }
  }
                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-2">
                      ...
                      />
                      <div>
                        {errors.brand && <span className="text-sm text-lime-500">{errors.brand.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <div>
                        {errors.item && <span className="text-sm text-lime-500">{errors.item.message}</span>}
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-6">
                      ...
                      />
                      <div>
                        {errors.weight && <span className="text-sm text-lime-500">{errors.weight.message}</span>}
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-6 gap-6">
